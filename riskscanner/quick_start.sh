...
wget --no-check-certificate https://github.com/RiskScanner/riskscanner/releases/latest/download/riskscannerV${VERSION}.tar.gz
...
tar zxvf riskscannerV${VERSION}.tar.gz
cd riskscannerV${VERSION}/installer
